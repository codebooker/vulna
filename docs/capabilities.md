...
| Passive inventory, analytics, and report builder | Planned (Phase 44 core plus generic API, CSV, Kea DHCP, authoritative DNS, Active Directory, Microsoft Entra, and UniFi Network adapters present; remaining providers stacked separately) | No |
