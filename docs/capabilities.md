...
| Passive inventory, analytics, and report builder | Planned (Phase 44 core plus generic API, CSV, Kea DHCP, authoritative DNS, Active Directory, and Microsoft Entra adapters present; remaining providers stacked separately) | No |
