...
HELP_TOPICS: dict[str, HelpTopic] = {
    ...
    "networking": HelpTopic(
        "networking", "Changing the URL or certificate",
    ...
    "low-resource": HelpTopic(
        "low-resource", "Low-resource and offline operation",
    ...
    "exposure": HelpTopic(
        "exposure", "Exposing Vulna beyond your LAN",
